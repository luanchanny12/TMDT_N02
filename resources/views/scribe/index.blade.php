...
<head>
    ...
    <title>DK Social Commerce API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETforgot-password">GET forgot-password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTforgot-password">
                                <a href="#endpoints-POSTforgot-password">POST forgot-password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETreset-password--token-">
                                <a href="#endpoints-GETreset-password--token-">GET reset-password/{token}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTreset-password">
                                <a href="#endpoints-POSTreset-password">POST reset-password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETauth-google">
                                <a href="#endpoints-GETauth-google">Redirect sang trang đăng nhập của Google.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETauth-google-callback">
                                <a href="#endpoints-GETauth-google-callback">Google callback — xử lý sau khi user đồng ý cấp quyền.</a>
                            </li>
...
<p>Backend API documentation cho dự án DK Social Commerce — một nền tảng thương mại điện tử tích hợp Social Sharing, Referral System và AI Chatbot.</p>
<aside>
...
<p>To authenticate requests, include an <strong><code>Authorization</code></strong> header with the value <strong><code>"Bearer {SESSION_COOKIE}"</code></strong>.</p>
<p>All authenticated endpoints are marked with a <code>requires authentication</code> badge in the documentation below.</p>
<p>Đăng nhập tại <b>/login</b> để có session cookie. Các endpoint cần auth sẽ được đánh dấu <code>🔒 Requires authentication</code>.</p>

        <h1 id="authentication">Authentication</h1>

    

                                <h2 id="authentication-GETlogin">Trang đăng nhập</h2>
...
&lt;body&gt;
    ...
    &lt;div class=&quot;auth-card p-4 p-md-5&quot;&gt;
        ...
        &lt;div class=&quot;text-center mb-4&quot;&gt;
            ...
            &lt;p class=&quot;text-muted small mt-1&quot;&gt;Đăng nhập để tiếp tục mua sắm&lt;/p&gt;
        &lt;/div&gt;
        ...
        &lt;form method=&quot;POST&quot; action=&quot;http://127.0.0.1:8000/login&quot;&gt;
            ...
            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium d-flex justify-content-between&quot;&gt;
                    Mật khẩu
                    &lt;a href=&quot;http://127.0.0.1:8000/forgot-password&quot; class=&quot;text-muted small&quot;&gt;Qu&ecirc;n mật khẩu?&lt;/a&gt;
                &lt;/label&gt;
        ...
        &lt;a href=&quot;http://127.0.0.1:8000/auth/google&quot; class=&quot;btn btn-google w-100 py-2 d-flex align-items-center justify-content-center gap-2&quot;&gt;
        ...
        &lt;p class=&quot;text-center text-muted small mt-3&quot;&gt;
            ...
            &lt;a href=&quot;http://127.0.0.1:8000/register&quot; class=&quot;text-primary fw-medium&quot;&gt;Đăng k&yacute; ngay&lt;/a&gt;
        &lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTlogin">Đăng nhập</h2>

<p>
</p>

<p>Đăng nhập bằng email và mật khẩu. Trả về redirect với session cookie.</p>
...
<span id="example-responses-POSTlogin">
            <blockquote>
            <p>Example response (302, Đăng nhập thành công):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{}</code>
            ...
            <blockquote>
            <p>Example response (422, Sai email/mật khẩu):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;errors&quot;: {
        &quot;email&quot;: [
            &quot;Email hoặc mật khẩu kh&ocirc;ng ch&iacute;nh x&aacute;c.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="admin@dksc.local"
               data-component="body">
    <br>
<p>Email của tài khoản. Example: <code>admin@dksc.local</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Ghi nhớ đăng nhập (tuỳ chọn). Example: <code>true</code></p>
        </div>
        </form>

                    <h2 id="authentication-GETregister">Trang đăng ký</h2>
...
&lt;body&gt;
    ...
    &lt;div class=&quot;auth-card p-4 p-md-5&quot;&gt;
        &lt;div class=&quot;text-center mb-4&quot;&gt;
            &lt;div class=&quot;fw-bold fs-4 text-primary&quot;&gt;🛍️ DK Social Commerce&lt;/div&gt;
            &lt;p class=&quot;text-muted small mt-1&quot;&gt;Tạo t&agrave;i khoản mới&lt;/p&gt;
        &lt;/div&gt;
        ...
        &lt;form method=&quot;POST&quot; action=&quot;http://127.0.0.1:8000/register&quot;&gt;
            ...
            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium&quot;&gt;Họ t&ecirc;n&lt;/label&gt;
                &lt;input type=&quot;text&quot; name=&quot;name&quot; class=&quot;form-control &quot;
                    value=&quot;&quot; placeholder=&quot;Nguyễn Văn A&quot; autofocus required&gt;
                            &lt;/div&gt;

            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium&quot;&gt;Email&lt;/label&gt;
                &lt;input type=&quot;email&quot; name=&quot;email&quot; class=&quot;form-control &quot;
                    value=&quot;&quot; placeholder=&quot;ban@example.com&quot; required&gt;
                            &lt;/div&gt;

            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium&quot;&gt;Mật khẩu&lt;/label&gt;
                &lt;input type=&quot;password&quot; name=&quot;password&quot; class=&quot;form-control &quot;
                    placeholder=&quot;&Iacute;t nhất 8 k&yacute; tự&quot; required&gt;
                            &lt;/div&gt;

            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium&quot;&gt;X&aacute;c nhận mật khẩu&lt;/label&gt;
        ...
        &lt;a href=&quot;http://127.0.0.1:8000/auth/google&quot; class=&quot;btn btn-google w-100 py-2 d-flex align-items-center justify-content-center gap-2&quot;&gt;
            &lt;svg width=&quot;18&quot; height=&quot;18&quot; viewBox=&quot;0 0 24 24&quot;&gt;&lt;path fill=&quot;#4285F4&quot; d=&quot;M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z&quot;/&gt;&lt;path fill=&quot;#34A853&quot; d=&quot;M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z&quot;/&gt;&lt;path fill=&quot;#FBBC05&quot; d=&quot;M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z&quot;/&gt;&lt;path fill=&quot;#EA4335&quot; d=&quot;M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z&quot;/&gt;&lt;/svg&gt;
            Đăng k&yacute; với Google
        &lt;/a&gt;

        &lt;p class=&quot;text-center text-muted small mt-3&quot;&gt;
            Đ&atilde; c&oacute; t&agrave;i khoản?
            &lt;a href=&quot;http://127.0.0.1:8000/login&quot; class=&quot;text-primary fw-medium&quot;&gt;Đăng nhập&lt;/a&gt;
        &lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
    &lt;script src=&quot;https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js&quot;&gt;&lt;/script&gt;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTregister">Đăng ký tài khoản</h2>

<p>
</p>

<p>Tạo tài khoản mới, tự động sinh <code>referral_code</code>, đăng nhập ngay sau đó.</p>
...
<span id="example-responses-POSTregister">
            <blockquote>
            <p>Example response (302, Đăng ký thành công, redirect về trang chủ):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{}</code>
            ...
            <blockquote>
            <p>Example response (422, Email đã tồn tại):</p>
        </blockquote>
                <pre>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;errors&quot;: {
        &quot;email&quot;: [
            &quot;Email n&agrave;y đ&atilde; được sử dụng.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Họ tên. Example: <code>Nguyễn Văn A</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Email (phải duy nhất). Example: <code>newuser@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Xác nhập mật khẩu. Example: <code>password123</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTlogout">Đăng xuất</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Hủy session hiện tại và redirect về trang đăng nhập.</p>
...
<div class="bash-example">
    ...
    --header "Authorization: Bearer {SESSION_COOKIE}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTlogout">
            <blockquote>
            <p>Example response (302, Đăng xuất thành công):</p>
        </blockquote>
                <pre>
...
&nbsp;
 ...
 &nbsp;
               ...
               value="Bearer {SESSION_COOKIE}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {SESSION_COOKIE}</code></p>
            </div>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETforgot-password">GET forgot-password</h2>
...
&lt;body&gt;
    ...
    &lt;div class=&quot;auth-card p-4 p-md-5&quot;&gt;
        ...
        &lt;p class=&quot;text-muted small mb-3&quot;&gt;
            Nhập email của bạn v&agrave; ch&uacute;ng t&ocirc;i sẽ gửi link để đặt lại mật khẩu.
        &lt;/p&gt;
        ...
        &lt;p class=&quot;text-center text-muted small mt-3&quot;&gt;
            &lt;a href=&quot;http://127.0.0.1:8000/login&quot; class=&quot;text-primary&quot;&gt;&larr; Quay lại đăng nhập&lt;/a&gt;
        &lt;/p&gt;
    &lt;/div&gt;
&lt;/div&gt;
    &lt;script src=&quot;https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js&quot;&gt;&lt;/script&gt;
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTforgot-password">POST forgot-password</h2>
...
<p>Must be a valid email address. Must match an existing stored value. Example: <code>gbailey@example.net</code></p>
                    ...
                    <h2 id="endpoints-GETreset-password--token-">GET reset-password/{token}</h2>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://127.0.0.1:8000/reset-password/architecto';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
&lt;body&gt;
    ...
    &lt;div class=&quot;auth-card p-4 p-md-5&quot;&gt;
        ...
        &lt;form method=&quot;POST&quot; action=&quot;http://127.0.0.1:8000/reset-password&quot;&gt;
            ...
            &lt;div class=&quot;mb-3&quot;&gt;
                &lt;label class=&quot;form-label fw-medium&quot;&gt;X&aacute;c nhận mật khẩu mới&lt;/label&gt;
                &lt;input type=&quot;password&quot; name=&quot;password_confirmation&quot; class=&quot;form-control&quot;
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTreset-password">POST reset-password</h2>
...
<p>Must be at least 8 characters. Example: <code>-0pBNvYgxw</code></p>
                    ...
                    <h2 id="endpoints-GETauth-google">Redirect sang trang đăng nhập của Google.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETauth-google-callback">Google callback — xử lý sau khi user đồng ý cấp quyền.</h2>
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://127.0.0.1:8000/auth/google/callback';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
<div class="php-example">
    <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'http://127.0.0.1:8000/storage/|{+-0p';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
