...
return [
    ...
    'description' => 'Backend API documentation cho dự án DK Social Commerce — một nền tảng thương mại điện tử tích hợp Social Sharing, Referral System và AI Chatbot.',
    ...
    'routes' => [
        [
            ...
            'include' => [],
            'exclude' => [
                // Bỏ qua các route nội bộ của Scribe, Telescope, health check
                '_ignition/*',
                'telescope/*',
                'up',
                'docs',
    ...
    'example_languages' => [
        'bash',
        'javascript', // Axios — bạn frontend dễ copy
        'php',
    ],
